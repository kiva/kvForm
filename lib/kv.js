...
(function ($, kv, global, undefined) {
	...
	function jqueryExtend(methodName, settings) {
		...
		jQueryMethodName = 'kv' + methodName.charAt(0).toUpperCase() + methodName.slice(1);

		// Create the function that will be the method on the jQuery object.
		$.fn[jQueryMethodName] = function (options) {
			var opts = {};
